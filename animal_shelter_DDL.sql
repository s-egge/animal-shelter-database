...
VALUES ('1', 1, (SELECT name FROM Vaccines WHERE vaccineID = VaccinesAdministered.vaccineID), '2022-12-1', '2023-10-12'),
('1', 2, (SELECT name FROM Vaccines WHERE vaccineID = VaccinesAdministered.vaccineID),'2022-12-1', '2023-10-12' ),
('2', 2, (SELECT name FROM Vaccines WHERE vaccineID = VaccinesAdministered.vaccineID), '2022-12-1', '2023-10-12'),
('2', 1,  (SELECT name FROM Vaccines WHERE vaccineID = VaccinesAdministered.vaccineID), '2022-12-10', '2023-10-12'),
('3', 4,  (SELECT name FROM Vaccines WHERE vaccineID = VaccinesAdministered.vaccineID), '2022-03-10', '2023-03-12'),
('6', 2,  (SELECT name FROM Vaccines WHERE vaccineID = VaccinesAdministered.vaccineID), '2022-12-1', '2023-01-12'),
('5', 1,  (SELECT name FROM Vaccines WHERE vaccineID = VaccinesAdministered.vaccineID), '2022-12-1', '2023-10-12'),
('5', 2,  (SELECT name FROM Vaccines WHERE vaccineID = VaccinesAdministered.vaccineID), '2021-12-1', '2023-10-12');
