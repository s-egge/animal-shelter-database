...
templates['animalTableRow'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<tr class=\"table-entry\">\r\n    <th>"
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"pictureURL") || (depth0 != null ? lookupProperty(depth0,"pictureURL") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"pictureURL","hash":{},"data":data,"loc":{"start":{"line":8,"column":31},"end":{"line":8,"column":45}}}) : helper)))
    + "></a></th>\r\n</tr>";
},"useData":true});
})();